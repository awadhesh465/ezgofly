                            ...
                            <div class="row">
                             ...
                             <div class="col-xs-12 col-sm-3 item">
                              <a href="<?php echo base_url('frontend/categoryposts/').$cat['category_id'] ?>">
                                <img src="<?php echo base_url('asset/images/'.$cat['category_image'])?>" class="img-responsive" alt="Category image" title="Category image">
                              </a>
                               <a href="<?php echo base_url('frontend/categoryposts/').$cat['category_id'] ?>">
                        ...
                        <div class="line-content">
                            ...
                            <div class="user-details">
                              <?php if($post_detail[0]->image){ ?>
                                <img src="<?php echo base_url('/asset/uploads/profile/'.$post_detail[0]->image)?>" alt="profile image" title="profile image">
                              <?php }else{?>
                                <img src="<?php echo base_url('/asset/images/user.png')?>" alt="profile image" title="profile image">
                              <?php  
                               } ?>  
                            ...
                            <div class="user-dpost">
                               <?php if(!empty($post_detail[0]->media_file)){ ?>
                                <div class="img <?php if(empty($post_detail[0]->title) && empty($post_detail[0]->contents)){ echo 'abc'; } ?> img-list">
                                  <!-- <a href="<? //echo base_url('frontend/detail/').$post_detail[0]->feed_id; ?>"> -->
                                  <?php //if(in_array($post->media_filetype,$imagetype))
                                     ...
                                     <a href="" class="ab">
                                    <img src="<?php echo base_url('/asset/uploads/post/thumb/'.$post_detail[0]->media_file)?>" class="img-responsive" alt="Post image" title="Post image"></a>
                                   <?php }
                                ...
                                <div class="content <?php if(empty($post_detail[0]->media_file)) echo "conetnt-fillwidth" ?> <?php if(empty($post_detail[0]->title) && empty($post_detail[0]->contents)){ echo 'xyz'; } ?>">
                                    ...
                                    <div class="row">
                                      <div class="col-xs-10 col-sm-10 padding-0">
                                        <h2><a href="<? echo base_url('frontend/news_detail/').$post_detail[0]->feed_id; ?>"><?php echo  $post_detail[0]->title; ?></a></h2>
                                      </div>
                                      <div class="col-xs-2 col-sm-2 padding-0">
                                      <a href="http://www.facebook.com/sharer.php?u=<?php echo base_url('frontend/news_detail/').$post_detail[0]->feed_id; ?>" target="_blank">
                                                     <img src="<?php echo base_url('asset/images/share.png'); ?>" class="share-icon">
                                                     </a>
                                         <!-- <img src=" <?php//echo base_url('/asset/images/report.png')?>" class="report-icon" data-toggle="modal" data-target="#myModal"> -->

                                        <div class="modal fade popup-login" id="myModal" role="dialog">
                                                      ...
                                                      <form class="form center-block" role="form" method="post" action="<?php echo base_url('frontend/report_abuse') ?>"  enctype="multipart/form-data" >
                                                        <div class="modal-body">
                                                          <div class="form-group">
                                                            <input type="hidden" name="post_id" value="<?php echo $post_detail[0]->feed_id; ?>">
                                    ...
                                    <p><?php echo findURLTurnToClickableLink($post_detail[0]->contents); ?> </p>
                                
                                    <div class="row">
                                       <div class="comment-section img-list">
                                            <?php 
                                              if(isset($post_detail[0]->comments))
                                               {
                                                    ...
                                                    <div class="ac ac-1">
                                                     ...
                                                     <div class="img-container1">
                                                      <?php if(!empty($comment->image)){ ?>
                                                       <img with="20" height="20" src="<?php echo base_url('/asset/uploads/profile/'.$comment->image)?>" class="profile-img" alt="profile image" title="profile image">
                                                     ...
                                                     <div class="content-container1">
                                                      ...
                                                      if(!empty($comment->file)){ 
                                                        ...
                                                        <a href="" class="ab"><img src="<?php echo base_url('/asset/uploads/post/thumb/'.$comment->file)?>" class="img-responsive" alt=""></a>
                                                       <?php }
                                                       elseif($comment->file_type=='ogg' || $comment->file_type=='mp4'||$post_detail[0]->media_filetype=='mov' ||$post_detail[0]->media_filetype=='m4v'){?>
                                           ...
                                           <div class="col-xs-12 col-sm-12 left comment-icon-div" style="padding: 0px;">
                                                <ul>
                                                    ...
                                                    <li>
                                                            <img src="<?php echo base_url('asset/images/comment.png')?>" data-toggle="collapse" data-target="#demo<?php echo $key; ?>" alt="" alt="image" title="image">
                                                          ...
                                                          <div class="input-div">
                                                           <form action="javascript:void(0)" id="upload_form" enctype="multipart/form-data" method="post">     
                                                            <input type="hidden" id="id" value="<?php echo $key; ?>" name="id">
                                                             <input type="hidden" id="post_id<?php echo $key; ?>" value="<?php echo $post_detail[0]->feed_id; ?>" name="post_id">
                                                              ...
                                                              <ul class="camera-ul">
                                                                <li>
                                                                  ...
                                                                  <div class="file-with-camera">
                                                                    ...
                                                                    <input type="hidden" name="medianame<?php echo $key; ?>" value="" id="medianame<?php echo $key; ?>" >
                                                                    ...
                                                                    <input type="hidden" name="media" value="" id="mediadata<?php echo $key; ?>" >
                                                                     ...
                                                                     <input type="hidden" name="mediatype" value="" id="mediatype<?php echo $key; ?>" >
                                                                      ...
                                                                      <video id="commentvideo<?php echo $key; ?>" width="15%" height="15%" style="display: none" controls class="video-cont-2">
                                                                      </video> 

                                                                      <button id="<?php echo $key; ?>" type="submit" class="submit-upload-item"><span>Send</span> <i class="fa fa-chevron-right"></i></button>
                                                          ...
                                                          <div class="input-div">
                                                           <form action="javascript:void(0)" id="upload_form" enctype="multipart/form-data" method="post">     
                                                            <input type="hidden" id="id" value="0" name="id">
                                                             <input type="hidden" id="post_id0" value="<?php  echo $post_detail[0]->feed_id; ?>" name="post_id">
                                                                ...
                                                                <li>
                                                                  ...
                                                                  <input type="hidden" name="media" value="" id="mediadata0">
                                                                   ...
                                                                   <input type="hidden" name="mediatype" value="" id="mediatype0">
                                                                    ...
                                                                    <video id="commentvideo0" width="15%" height="15%" style="display: none" controls class="video-cont-2 3">

                                                                      <!-- <button id="< ?php echo $key; ?>" type="submit" class="submit-upload-item" style="display:none"><i class="fa fa-chevron-right"></i></button> -->

                                                                      <button id="<?php echo $i; ?>" type="submit" class="submit-upload-item"> <span>Send</span> <i class="fa fa-chevron-right"></i></button>
