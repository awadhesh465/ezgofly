    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"> <a class="btn btn-primary" href="<?php echo base_url('superadmin/staff')?>"><i class="fa fa-th-list">&nbsp;Add Staff </i></a> </div>
                        ...
                        <table class="table table-bordered display nowrap" cellspacing="0" width="100%" id="appointment">
                            ...
                            <tbody>
                                ...
                                <tr class="odd gradeX" id="tr_<?php echo $count;?>">
                                    ...
                                    <td>
                                        <a href="<?php echo base_url('superadmin/staff_detail/').$value->id; ?>"><?php  echo $value->username;?></a>
                                    </td>
                                    <td>
                                    ...
                                    <td class="center">
                                     <a title="Edit" href="<?php echo base_url('superadmin/staff/').$value->id; ?>"><i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>
                                       <a title="Delete" href="javascript:void(0)" onclick="delete_staff('<?php echo $value->id;?>','<?php echo $count;?>')"><i class="fa fa-trash-o" aria-hidden="true"></i></a>
                                         </td>
                                   </tr>
                                <?php $count++; } }?> </tbody>
                        </table>
...
function delete_staff(id,tr_id) {
    swal({
        title: "Are you sure?",
