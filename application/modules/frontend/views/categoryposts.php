                ...
                <div class="row">
                  ...
                  //                 print_r($posts);
                        ...
                        <?php if(isset($posts)){
                         ...
                         $videotype= array('ogg,mp3,mp4,mov, m4v,x-msvideo');
                      ...
                      <div class="">
                        <div class="post-detail-border main-div">
                            ...
                            <div class="user-details">
                              <?php if($post->image){ ?>
                                <img src="<?php echo base_url('/asset/uploads/profile/'.$post->image)?>" class="" alt="Profile image" title="Profile image">
                              <?php }else{?>
                               ...
                               <?php }
                                ...
                                <div class="content <?php if(empty($post->media_file)) echo "conetnt-fillwidth" ?> ">
                                   ...
                                   <!--  <span class="read-more">More...</span>
                                    <span class="avav" style="display: none;"> hi hello</span>
                                              ...
                                              if(isset($post->comments))
                                               ...
                                               <?php }
                                                ...
                                                <video width="50%" height="50%" controls>
                                                  <source src="<?php echo base_url('/asset/uploads/post/'.$comment->file)?>"  id="video" type="video/<?php echo $comment->file_type ?>">
                                                </video>
                               ...
                               <?php if(!empty($news_feed)){
                                ...
                                ?>
                                 <div class="stories-post">
                                     ...
                                     <div class="col-xs-9 col-sm-10 col-md-9 right">
