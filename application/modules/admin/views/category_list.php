    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading"> <a class="btn btn-primary" href="<?php echo base_url('admin/category') ?>"><i class="fa fa-th-list">&nbsp;Add Category </i></a> </div>
                        ...
                        <table class="table table-bordered display nowrap" cellspacing="0" width="100%" id="appointment">
                            ...
                            <tbody id="table_body">
                                ...
                                <tr class="odd gradeX" id="tr_<?php echo $count;?>">
                                        ...
                                        <td>
                                            <img src="<?php echo base_url('asset/images/').$value->category_image ?>" height="50px" width="50px">
                                        </td>
                                       
                                           
                                        <td class="center">
                                     
                                       <a title="View" href="<?php echo base_url('admin/category/').$value->category_id; ?>"><i class="fa fa-edit" aria-hidden="true"></i></a> ||
                                       <a title="Delete" href="javascript:void(0)" onclick="delete_category('<?php echo $value->category_id;?>','<?php echo $count;?>')"><i class="fa fa-trash-o" aria-hidden="true" style="color:red"></i></a>
                                      </td>
                                </tr>
                                <?php $count++; } }?> </tbody>
                        </table>
